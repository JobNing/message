...
const (
	Data_Ping_FullMethodName = "/data.Data/Ping"
)
...
func (c *dataClient) Ping(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
func (UnimplementedDataServer) Ping(context.Context, *Request) (*Response, error) {
...
func _Data_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DataServer).Ping(ctx, req.(*Request))
	}
